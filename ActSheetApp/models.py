...
class job_tb(models.Model):
	...
	actual_start_date=models.DateTimeField(max_length=100,default='')
	actual_end_date=models.DateTimeField(max_length=100,default='')
	client_id=models.ForeignKey(client_tb,on_delete=models.CASCADE,default='')
	branch_id=models.ForeignKey(branch_tb,on_delete=models.CASCADE,default='')
	status=models.CharField(max_length=100,default='Pending')
	created_at=models.DateTimeField(max_length=100,default='')
...
class customer_tb(models.Model):
	...
	repeat_customer=models.BooleanField(max_length=100,default='')
	repeat_customer_id=models.IntegerField(default='',null=True)
	repeat_customer_visit_date=models.DateTimeField(max_length=100,default='',null=True)
...
class staff_attendance_tb(models.Model):
	...
	short_break_in_1=models.CharField(max_length=100,default='',null=True)
	short_break_out_1=models.CharField(max_length=100,default='',null=True)
	short_break_in_2=models.CharField(max_length=100,default='',null=True)
	short_break_out_2=models.CharField(max_length=100,default='',null=True)
	short_break_in_3=models.CharField(max_length=100,default='',null=True)
	short_break_out_3=models.CharField(max_length=100,default='',null=True)
	short_break_in_4=models.CharField(max_length=100,default='',null=True)
	short_break_out_4=models.CharField(max_length=100,default='',null=True)
	client_id=models.ForeignKey(client_tb,on_delete=models.CASCADE,default='')
	created_at=models.DateTimeField(max_length=100,default='')
	updated_at=models.DateTimeField(max_length=100,default='')
