"""
Django settings for ActSheet project.
...
SECRET_KEY = 'django-insecure-p0lw%m_5-$&fjy=(kxc*2rzf9hqc)%_o2@=o1do$4mo^h2m8$_'
...
WSGI_APPLICATION = 'ActSheet.wsgi.application'
